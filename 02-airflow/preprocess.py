...
MAX_MEMORY="5g"
spark = SparkSession.builder.appName("taxi-fare-prediciton").master("local")\
                .config("spark.executor.memory", MAX_MEMORY)\
                .config("spark.driver.memory", MAX_MEMORY)\
                .getOrCreate()

trip_files = "/Users/ji/data-engineering/02-airflow/data/trips/*"
...
data_dir = "/Users/ji/data-engineering/02-airflow/data/"
